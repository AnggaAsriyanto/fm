...
const mybrand = 'angga•webdeveloper•'; // full name or job, adjust with font-size and letter spacing
brands.forEach(bt => {
...
// portfolio item, edit and add according to the same amount.
...
// miniblog item, edit and add according to the same amount.
